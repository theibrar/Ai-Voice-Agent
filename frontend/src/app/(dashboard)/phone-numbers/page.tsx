    ...
    <div className="space-y-6">
      ...
      {phoneNumbers.length > 0 ? (
        ...
        <div className="p-12 text-center bg-white rounded-2xl border border-[#E5EAF2] card-shadow space-y-3">
          ...
          <h3 className="text-sm font-bold text-[#172033]">No Phone Numbers Provisioned</h3>
          <p className="text-xs text-[#78849A] max-w-sm mx-auto">
            Your database contains 0 registered phone numbers. Click &apos;Provision New Number&apos; to allocate local or toll-free numbers.
          </p>
          <button
            onClick={() => setShowBuyModal(true)}
