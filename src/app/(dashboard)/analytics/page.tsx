...
export default function AnalyticsPage() {
  const { agents, funnelSteps } = useAppStore();
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="p-4 bg-white rounded-2xl border border-[#E5EAF2] card-shadow">
          ...
          <div className="text-2xl font-bold text-[#0F172A] mt-1">88.4%</div>
        ...
        <div className="p-4 bg-white rounded-2xl border border-[#E5EAF2] card-shadow">
          ...
          <div className="text-2xl font-bold text-[#0F172A] mt-1">$0.21</div>
        ...
        <div className="p-4 bg-white rounded-2xl border border-[#E5EAF2] card-shadow">
          ...
          <div className="text-2xl font-bold text-[#3157D5] mt-1">280ms</div>
        ...
        <div className="p-4 bg-white rounded-2xl border border-[#E5EAF2] card-shadow">
          ...
          <div className="text-2xl font-bold text-[#3157D5] mt-1">58.4%</div>
              ...
              <tbody className="divide-y divide-[#E5EAF2]">
                {agents.map((agent) => (
                  <tr key={agent.id} className="hover:bg-[#F4F7FB]/60 transition-colors">
                    ...
                    <td className="p-3 font-mono font-medium">{agent.metrics.totalCalls.toLocaleString()}</td>
                    <td className="p-3 font-semibold text-[#16A36A]">{agent.metrics.successRate}%</td>
                    <td className="p-3 font-mono">{formatDuration(agent.metrics.avgDurationSeconds)}</td>
                    <td className="p-3 font-bold text-[#3157D5]">{agent.metrics.sentimentScore}%</td>
                  </tr>
                ))}
              </tbody>
            </table>
