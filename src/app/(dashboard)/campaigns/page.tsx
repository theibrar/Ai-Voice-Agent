...
export default function CampaignsPage() {
  ...
  const avgConversion = (
    campaigns.reduce((acc, c) => acc + c.conversionRate, 0) / (campaigns.length || 1)
  ).toFixed(1);
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="p-4 bg-white rounded-2xl border border-[#E5EAF2] card-shadow">
          ...
          <div className="text-2xl font-bold text-[#172033] mt-1">110 Ports</div>
          <span className="text-xs text-[#16A36A] font-semibold mt-1 block">Auto-scaling SIP trunks</span>
        </div>
      </div>
