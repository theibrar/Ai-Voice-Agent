...
export default function AppointmentsPage() {
  ...
  const calendarDays = [
    ...
    { day: 15, label: "Mon", date: "Jun 15", events: ["David Miller (1:00 PM)"] },
    { day: 16, label: "Tue", date: "Jun 16", events: ["Elena Rostova (11:00 AM)"] },
    { day: 17, label: "Wed", date: "Jun 17", isToday: true, events: ["Jonathan Vance (2:00 PM)", "Sarah Jenkins (10:30 AM)"] },
    { day: 18, label: "Thu", date: "Jun 18", events: ["Michael Chang (4:30 PM)"] },
    { day: 19, label: "Fri", date: "Jun 19", events: ["Anna Wright (11:00 AM)"] },
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="p-5 bg-white rounded-3xl border border-[#E2E8F0] shadow-xs">
          ...
          <div className="text-2xl font-black text-[#3157D5] mt-1">30 Mins</div>
          <span className="text-xs text-[#64748B] mt-1 block">Auto Google Meet link generated</span>
        </div>
      </div>
