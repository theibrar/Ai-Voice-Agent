...
export const initialTenantOrgs: TenantAdminOrg[] = [
  {
    ...
    allowedLLMs: ["gpt-4o", "claude-3-5-sonnet", "gemini-1-5-pro", "deepseek-v3"],
...
export const initialSipCarriers: SipCarrierNetwork[] = [
  ...
  },
  {
    ...
    name: "LiveKit WebRTC Media Server (GPU RTX 5060)",
    carrier: "LiveKit GPU Cluster",
    status: "online",
    isDefault: false,
    fqdnOrIp: "85.218.235.6:7880",
    sipPort: 7880,
    transport: "WSS/TCP",
