    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="p-5 bg-white rounded-2xl border border-[#E5EAF2] card-shadow">
          ...
          <div className="text-2xl font-bold text-[#16A36A] mt-1">+0.0%</div>
          <span className="text-xs text-[#78849A] mt-1 block">No active traffic lift recorded</span>
        </div>
        ...
        <div className="p-5 bg-white rounded-2xl border border-[#E5EAF2] card-shadow">
          ...
          <span className="text-xs text-[#78849A] font-semibold mt-1 block">Awaiting sample calls</span>
        </div>
      </div>
