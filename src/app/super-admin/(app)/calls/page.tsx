    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
        ...
        <div className="p-5 bg-white rounded-3xl border border-[#E2E8F0] shadow-xs space-y-1">
          ...
          <div className="text-2xl font-black text-[#0F172A]">5.2 ms</div>
          <span className="text-xs text-emerald-600 font-bold">Sub-10ms Target</span>
        </div>

        <div className="p-5 bg-white rounded-3xl border border-[#E2E8F0] shadow-xs space-y-1">
          <span className="text-[10px] font-extrabold uppercase tracking-widest text-[#64748B]">Packet Loss</span>
          <div className="text-2xl font-black text-[#0F172A]">0.01 %</div>
          <span className="text-xs text-emerald-600 font-bold">Carrier SLA Compliant</span>
        </div>

        <div className="p-5 bg-white rounded-3xl border border-[#E2E8F0] shadow-xs space-y-1">
          <span className="text-[10px] font-extrabold uppercase tracking-widest text-[#64748B]">Est. Cost / Hour</span>
          <div className="text-2xl font-black text-[#3157D5] font-mono">$18.40 / hr</div>
          <span className="text-xs text-[#64748B]">Wholesale Carrier + LLM API</span>
        </div>
      </div>
